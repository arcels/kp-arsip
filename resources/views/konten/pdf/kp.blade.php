        ...
        <div class="">
            ...
            <div>
                ...
                <p style="padding: 5px 30px; text-align: justify;">
                    ...
                    Kami menunggu surat balasan dari Bapak/Ibu sebagai tanda bahwa mahasiswa kami diijinkan melakukan kerja praktek di {{$kp_perusahaan}} yang dilaksanakan pada Bulan {{date('d F Y', strtotime($kp_mulai))}}
                    sampai dengan Bulan {{date('d F Y', strtotime($kp_selesai))}} ({{$kp_durasi}}).
